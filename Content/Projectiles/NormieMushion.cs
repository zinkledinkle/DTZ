...
{
    public class NormieMushion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(null, Projectile.Center, Vector2.Zero, ModContent.ProjectileType<NormieMushionProj>(), 0, 0, 0, ai2: owner.whoAmI);
            }
