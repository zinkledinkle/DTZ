...
{
    public class IceliumMushion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            owner.AddBuff(ModContent.BuffType<IceliumBuff>(), 2);
            ...
            if (Projectile.ai[5]++ >= 60 * 20 && currentState != States.ability)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/IceliumMushion3") with { PitchVariance = .16f }, Projectile.Center);
            }
            ...
            else if (Projectile.ai[0] == 0)
            {
                if (currentState == States.taunt)
                {
                    if (Projectile.ai[4] == 0 && Projectile.ai[3] == 0)
                    {
                        ...
                        SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/IceliumMushion2") with { PitchVariance = .16f }, Projectile.Center);
                    }
                ...
                else
                {
                    ...
                    if (currentState == States.idle)
                    {
                        ...
                        {
                            Projectile.ai[4] = 1;
                            SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/IceliumMushion1") with { PitchVariance = .16f }, Projectile.Center);
                        }
            ...
            {
                Projectile.NewProjectile(null, Projectile.Center, Vector2.Zero, ModContent.ProjectileType<IceliumMushionProj>(), 0, 0, 0, ai2: owner.whoAmI);
            }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.IceGolem);
            }
