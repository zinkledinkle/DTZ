...
{
    public class CryingToadMushion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            owner.AddBuff(ModContent.BuffType<CryingToadBuff>(), 2);
            ...
            if (Projectile.ai[5]++ >= 60 * 20 && currentState != States.ability)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/ToadMushion3") with { PitchVariance = .16f }, Projectile.Center);
            }
