    ...
    public class HellcapMushion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[5]++ >= 60 * 20 && currentState != States.ability)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/HellcapMushion3") with { PitchVariance = .16f }, Projectile.Center);
            }
            ...
            else if (Projectile.ai[0] == 0)
            {
                if (currentState == States.taunt)
                {
                    ...
                    {
                        SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/HellcapMushion2") with { PitchVariance = .16f }, Projectile.Center);
                    }
