...
{
    public class Oppsgothim : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            owner.AddBuff(ModContent.BuffType<OppsgothimBuff>(), 2);
            ...
            if (Projectile.ai[5]++ >= 60 * 20 && currentState != States.ability)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/Oppsgot3") with { PitchVariance = .16f }, Projectile.Center);
            }
            ...
            else if (Projectile.ai[0] == 0)
            {
                if (currentState == States.taunt)
                {
                    if (Projectile.ai[4] == 0 && Projectile.ai[3] == 0)
                    {
                        ...
                        SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/Oppsgot2") with { PitchVariance = .16f }, Projectile.Center);
                    }
                ...
                else
                {
                    ...
                    if (currentState == States.idle)
                    {
                        ...
                        {
                            Projectile.ai[4] = 1;
                            SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/Oppsgot1") with { PitchVariance = .16f }, Projectile.Center);
                        }
        ...
        {
            SoundEngine.PlaySound(new SoundStyle("Mycology/Assets/Sounds/OppsPerish") with { PitchVariance = .16f }, Projectile.Center);
